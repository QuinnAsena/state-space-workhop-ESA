...
format:
  revealjs:
    ...
    width: 1600
    height: 900
    footer: "Repo: <https://github.com/QuinnAsena/state-space-workhop-ESA>"
...
- Relative abundance data mean we can generate estimates for $n-1$ taxa
...
_For example are species interactions or environmental covariates the primary driver of change?_
...
- We need to choose a resolution for those predictions
...
- We also make decisions around which parameters to estimate
