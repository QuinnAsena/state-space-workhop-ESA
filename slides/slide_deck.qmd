...
- One of the primary goals of this model is to be able to test multiple hypotheses about the data and lend statistical support to the different hypotheses. 
  - which environmental drivers are having the strongst effects on which taxa?
  - are interactions among taxa or abiotic variables driving change in the system? 
  - Fit models to address multiple working hypotheses (or hypothesis components)
...
- Work with uneven time-intervals between observations
- Woth with multinomially distributed data
...
- Fit the model to different combinations of parameters
