...
- macOS: to install xcode select on mac, open a terminal and run: `xcode-select --install`

- To install Rtools44 on go to this link: https://cran.r-project.org/bin/windows/Rtools/rtools44/rtools.html


## Introduction

This workshop will take you through how to fit the `multinomialTS` model and interpret the results. Hypothesis testing...
